...
This vignette provides an example of conditioning an Operating Model (OM) on a stock assessment, then runs example harvest control rules (HCRs).
...
```{r, eval=FALSE}
install.packages(c("FLCore","FLFishery","FLasher","FLBRP","kobe","FLife"), 
...
```{r,echo=FALSE}
load("/home/laurence/Desktop/Dropbox/bluewhiting/data/om.RData")
load("/home/laurence/Desktop/Dropbox/bluewhiting/data/retro.RData")
```
...
'om1' is the blue whiting stock assessment amd 'om' is the assessment with a 1000 replicates with estimation error.
