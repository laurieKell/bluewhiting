...
grid.raster(readPNG("/home/laurence/Desktop/Dropbox/PELAC/bluewhiting/R/tex/om-bhsv-1.png"))
```
...
```{r, fig.height=6, echo=FALSE}
grid.raster(readPNG("/home/laurence/Desktop/Dropbox/PELAC/bluewhiting/R/tex/sim1-unnamed-chunk-4-1.png"))
```
...
fn12<-function(yr) {
  print(kobePhaseMar2(subset(pts,year==yr&
            ...
            xlim=c(0,1e7),ylim=c(0,1),
              quadcol=rep(c("white"),4),
              bref=2250000,fref=0.32,layer=
geom_point(aes(ssb,f,fill=run),size=.2,
           data=subset(transform(chk,run=Scenario),run%in%c("sim1","sim2"))), 
xlab="SSB",ylab="F"))}  
```
