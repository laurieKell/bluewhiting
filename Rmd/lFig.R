...
lFig[10]<-"Estimates of SSB and recruitment with fitted Beverton and Holt stock recruitment relationship with a fixed steepness of 0.9"
lFig[11]<-"Recruitment deviates for Beverton and Holt stock recruitment relationship, with regimes estimated by STARS algorithm showing changes in mean and variance."
lFig[12]<-"Recruitment deviates for segmented regression stock recruitment relationship, with regimes estimated by STARS algorithm showing changes in mean and variance."
lFig[13]<-"Recruitment deviates for Beverton and Holt stock recruitment relationship with steepness fixed at 0.9, with regimes estimated by STARS algorithm showing changes in mean and variance."
lFig[14]<-"Autocorrelation in recruitment deviates."
lFig[15]<-"An example of simulated recruitment deviates with autocorrelation."
lFig[17]<-"Biological reference points based on the fitted segmented regression stock recruitment relationship."
lFig[16]<-"Biological reference points based on the Beverton and Holt stock recruitment relationship."
lFig[18]<-"Biological reference points based on the Beverton and Holt stock recruitment relationship with steepness fixed at 0.9."
lFig[19]<-"F0.1 reference point calculated with a five year moving window"
